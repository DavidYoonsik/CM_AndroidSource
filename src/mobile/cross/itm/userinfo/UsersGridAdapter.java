...
public class UsersGridAdapter extends BaseAdapter {
	...
	public UsersGridAdapter(Context c, ArrayList<HashMap<String, String>> list) {
		context = c;
		this.list = list;
		i = new ImageDownLoad(c);
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		i.DisplayImage(map.get(VariableManager.PRODUCT_IMAGE), pro_image);
